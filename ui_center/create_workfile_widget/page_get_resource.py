...
from ui_center.create_workfile_widget import _mock_data as mock
from functools import partial


class MGetResourcePage(QtWidgets.QWizardPage):
    def __init__(self, parent=None):
        super(MGetResourcePage, self).__init__(parent)
        self.setWindowTitle("Create Resource")
        self._init_ui()
        self.bind_function()

    def _init_ui(self):
        title_lay = QtWidgets.QFormLayout()
        title_lay.addWidget(MLabel("Select/Create Resource").h2())
