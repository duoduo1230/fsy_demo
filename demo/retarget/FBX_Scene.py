...
class FBX_Class(object):
    ...
    def get_class_nodes(self, class_id):
        ...
        """
        nodes = []
        num_objects = self.scene.RootProperty.GetSrcObjectCount(fbx.FbxCriteria.ObjectType(class_id))
    ...
    def get_time_range(self):
        ...
        if not self.root_node.GetAnimationInterval(time_span, anim_stack, 0):
            print("Failed not amin curve")
            return 0, 0
