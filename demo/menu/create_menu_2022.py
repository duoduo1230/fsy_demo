...
def init_menu():
    ...
    # 创建 QC
    cmds.menuItem(label="QC Manager", parent=toolkit_menu, command="import QC_widget;import importlib;importlib.reload(QC_widget);QC_widget.main()")
    ...
    cmds.menuItem(label="Create Human IK", parent=toolkit_menu,
                  command="from create_human_ik import create_humanIK_widget;import importlib;importlib.reload(create_humanIK_widget);create_humanIK_widget.main()")

    # 创建retarget
    cmds.menuItem(label="Retarget Tool", parent=toolkit_menu,
                  command="from retarget import ani_retarget_widget;import importlib;importlib.reload(ani_retarget_widget);ani_retarget_widget.main()")
    ...
    cmds.menuItem(label="Playblast", parent=toolkit_menu,
                  command="import pb_with_shotmask;;import importlib;from pb_with_shotmask import playblast_mask_UI;importlib.reload(playblast_mask_UI);playblast_mask_UI.main()")
